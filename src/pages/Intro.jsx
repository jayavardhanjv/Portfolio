...
function MainPage() {
    ...
    return(
        ...
        <section class="relative w-full  min-h-[100vh] py-28 flex flex-col text-center items-center justify-center  sm:px-14 overflow-x-hidden isolate max-w-[calc(1234px + 56px * 2)] gap-4 md:gap-6 px-4 pt-8 md:pt-12 pb-8" >
            ...
            <h1 class="display:inline-block;vertical-align:top;text-decoration:inherit;text-wrap:balance text-[#888] text-[max(15px,min(2vw,20px))] leading-[1.8]  z-[1] p-[24px] left-1 text-xl font-bold">Hello there..! I’m</h1>
