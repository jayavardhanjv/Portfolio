...
const Contact = () => {
  return (
    <>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                 <div class="space-y-4 mt-6">
                        ...
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" class="w-5 h-5 ">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z">
                                ...
                                <p class="ml-4 text-center text-sm dark:text-accent-foreground">
                                    <a class="underline underline-offset-4 hover:text-primary text-black" href="mailto:jjayavardhan81.gmail.com">hellojv.dev.gmail.com</a>
                                </p>
                    </div>
                    <div class="flex items-center  ">
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" class="w-5 h-5 ">
                    ...
                    <div class="flex items-center  ">
                        ...
                        <p class="ml-4 text-center text-sm dark:text-accent-foreground ">
                            <a class="underline underline-offset-4 hover:text-primary text-black" href="https://github.com/jayavardhanjv">JayavardhanJ</a>
                        </p>
                        </div>
                        <div class="flex items-center  ">
                            ...
                            <p class="ml-4 text-center text-sm dark:text-accent-foreground">
                                <a class="underline underline-offset-4 hover:text-primary text-black" href="https://www.linkedin.com/in/jayavrdhan-jv/">JayavrdhanJ</a>
                            </p>
                        </div>
                    <div class="flex items-center  ">
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" class="w-5 h-5 ">
      ...
      <p class="text-center text-sm leading-loose text-accent dark:text-foreground ">Designed and developed by &ensp;  
         <a target="_blank" rel="noreferrer" class="font-medium text-black " href="https://github.com/jayavardhanjv">Jayavardhan J</a>&ensp; 
          deployed with  <span class="font-medium text-black">VS Code </span>. Crafted with <a target="_blank" rel="noreferrer" class="font-medium text-black " href="https://react.dev/">Reactjs </a>&ensp;and&ensp;
           <a target="_blank" rel="noreferrer" class="font-medium  text-black" href="https://tailwindcss.com/">Tailwind CSS 
           </a>, deployed with <a target="_blank" rel="noreferrer" class="font-medium  text-black" href="https://vercel.com/">Vercel</a>&ensp;and&ensp;
        <a target="_blank" rel="noreferrer" class="font-medium text-black " href="https://github.com/jayavardhanjv">GitHub</a>.</p>
    </>
  );
};
