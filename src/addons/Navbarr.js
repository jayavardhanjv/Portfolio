import logo from "../addons/logos/bblogo.png"
import handgif from "../addons/logos/hand.gif"
function Navbarr() {
    return(
        <nav class="bg-white border-white-100 dark:border-white-100 dark:border-white-100    supports-backdrop-blur:bg-background/60 sticky backdrop-blur-[5px] z-20     dark:bg-background/60 shadow-sm dark:shadow-neutral-200">
            <div class="max-w-screen-xl flex-wrap justify-between mx-auto  container flex h-14 items-center px-1 sm:px-3 lg:px-4">
                <a href="/" class="flex items-center ">
                    <img src={logo} class="h-16 max-w-full" alt="JV.dev logo" />
                </a>
    ...
    <div class="hidden w-full md:block md:w-auto items-center" id="navbar-solid-bg">
      <ul class="flex flex-col font-semibold mt-4 rounded-lg items-center bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-text-black">
        <li>
          <a href="#" class="font-semibold hidden sm:flex transition-colors dark:hover:bg-foreground/10  hover:bg-background/10 px-3 py-2 hover:rounded-lg  hover:dark:text-foreground dark:text-foreground/60">About</a>
        </li>
        <li>
          <a href="#" class="font-semibold hidden sm:flex transition-colors dark:hover:bg-foreground/10  hover:bg-background/10 px-3 py-2 hover:rounded-lg  hover:dark:text-foreground dark:text-foreground/60">Projects</a>
        </li>
        <li>
        ...
        <li>
        <button type="button" class="text-white  bg-[#050708] hover:bg-black focus:ring-4 focus:outline-none focus:ring-black font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-black dark:hover:bg-black mr-2 mb-2">
                     Contact Me
